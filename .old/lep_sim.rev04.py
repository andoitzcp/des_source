...
class lab_model:
    ...
    def generate_cv_st_qced_arrivals(self):
        while self.csqa<g.cv_st_qced_req:
            ...
            self.env.process(self.test_proc(csq))
    ...
    def test_proc(self, cubierta):
        ...
        with self.butler_mach.request() as req_butler:
            ...
            while time_left_rim > 0:  
                ...
                with self.technicians.request(priority=0, preempt=False) as req_tech:
                    ...
                    cv_rim_q_d = cv_rim_start_t - cv_gen_t
        ...
        cv_rim_proc_d = cv_rim_end_t - cv_rim_start_t
        ...
        with self.indoor_mach.request() as req_indoor:
            ...
            while time_left_mount > 0:
                ...
                with self.technicians.request(priority=0, preempt=False) as req_tech:
                    ...
                    cv_mount_q_d = cv_mount_start_t - cv_rim_end_t
            ...
            sampled_test_duration = random.betavariate(1193.6818459069568, 51.89131856237492)
        ...
        df_to_add = pd.DataFrame({"CV_ID":[cubierta.id],
                                  "TEST_run":[test_runned],
                                  "CV_gen_t":[cv_gen_t],
                                  "CV_rim_q_d":[cv_rim_q_d],
                                  "CV_rim_start_t":[cv_rim_start_t],
                                  "CV_rim_end_t":[cv_rim_end_t],
                                  "CV_rim_proc_d":[cv_rim_proc_d],
